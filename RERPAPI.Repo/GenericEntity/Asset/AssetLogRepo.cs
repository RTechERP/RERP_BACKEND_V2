...
namespace RERPAPI.Repo.GenericEntity.Asset
{
    public class AssetLogRepo : GenericRepo<AssetLog>
    {
        ...
        {
            // ── TSAsset ──
            ["TSCodeNCC"] = "Mã tài sản",
            ["Seri"] = "Số seri",
            ["Model"] = "Model",
            ["TSAssetName"] = "Tên tài sản",
            ["EmployeeID"] = "Người quản lý",
            ["TSAssetID"] = "Loại tài sản",
            ["UnitID"] = "Đơn vị",
            ["SourceID"] = "Nguồn gốc",
            ["DateBuy"] = "Ngày mua",
            ["Insurance"] = "Thời gian bảo hành",
        ...
        {
            if (value == null || !int.TryParse(value.ToString(), out int v) || v == 0) return "Trống";
            return v switch
            {
                1 => "Chưa Active",
                2 => "Đã Active",
