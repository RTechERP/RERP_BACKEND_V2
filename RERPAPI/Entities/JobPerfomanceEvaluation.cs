...
public partial class JobPerfomanceEvaluation
{
    ...
    /// <summary>
    /// Kết quả thực hiện : nhìn chung công việc
    /// </summary>
    ...
    /// Tên Người đánh giá
    /// </summary>
    public string? EmployeeEvaluationName { get; set; }

    /// <summary>
    /// Kết quả thực hiện : ý thức trách nhiệm
    /// </summary>
    public string? ResultOfImplementationConsciousness { get; set; }
