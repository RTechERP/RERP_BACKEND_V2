...
namespace RERPAPI.Controllers
{
	...
	{
		VisitFactoryDetailRepo repo = new VisitFactoryDetailRepo();
		...
		public IActionResult GetAll(int? visitFactoryID)
		{
			try
			{
				List<VisitFactoryDetail> items = visitFactoryID.HasValue
					? repo.GetAll(x => x.VisitFactoryID == visitFactoryID.Value && !x.IsDeleted)
					: repo.GetAll(x => !x.IsDeleted);
