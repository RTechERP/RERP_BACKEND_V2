...
namespace RERPAPI.Controllers.KHOAHOC
{
    ...
    [ApiController]
    [Authorize]
    public class CourseExamWebController : ControllerBase
    {
        ...
        public CourseExamWebController(CourseExamRepo courseExamRepo,
        ...
        public IActionResult GetCourseQuestion(int? examID)
        {
            ...
            {
                examID = examID ?? 0;
                var data = SQLCourseHelper<object>.ProcedureToList("spGetCourseQuestion",
                                                new string[] { "@ExamID" },
                                                new object[] { examID });
        ...
        public IActionResult GetCourseQuestionExport(int? examID)
        {
            try
            {
                ...
                var data = SQLCourseHelper<object>.ProcedureToList("spGetCourseQuestion",
                                                new string[] { "@ExamID" },
                                                new object[] { examID });
                var data0 = SQLCourseHelper<object>.GetListData(data, 1);
        ...
        public IActionResult GetRightAnswer(int? questionID)
        {
            try
            {
                ...
                var data = SQLCourseHelper<object>.ProcedureToList("spGetCourseAnswersByCourseQuestionID",
        ...
        public IActionResult GetLessonExam(int? courseID)
        {
            ...
            {
                courseID = courseID ?? 0;
                var data = SQLCourseHelper<object>.ProcedureToList("spGetLessonExamByLessonID",
                                                new string[] { "@CourseID" },
                                                new object[] { courseID });
        ...
        public IActionResult GetCourseAnswers(int? questionID)
        {
            ...
            {
                questionID = questionID ?? 0;
                var data = SQLCourseHelper<object>.ProcedureToList("spGetCourseAnswers",
        ...
        public async Task<IActionResult> SaveCourseQuestion([FromBody] SaveCourseQuestionParamWeb data)
        {
            try
            {
                ...
                // var countDeleteCourseRightAnswer =  await _courseRightAnswerRepo.DeleteByAttributeAsync("CourseQuestionID", data.Question.ID);
                // xoá hết câu trả lời đúng cũ
