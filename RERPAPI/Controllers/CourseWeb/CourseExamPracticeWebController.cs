...
namespace RERPAPI.Controllers.KHOAHOC
{
    ...
    [ApiController]
    [Authorize]
    public class CourseExamPracticeWebController : ControllerBase
    {
        private readonly CourseExamRepo _courseExamRepo;
        private readonly CourseAnswersRepo _courseAnswerRepo;
        ...
        public IActionResult GetCourseExam(int? courseID)
        {
            ...
            {
                courseID = courseID ?? 0;
                var data = SQLCourseHelper<object>.ProcedureToList("spGetCourseExam",
                                                new string[] { "@CourseID" },
                                                new object[] { courseID });
        ...
        public IActionResult GetCheckCourseExam(int? courseID)
        {
            try
            {
                ...
                var data = SQLCourseHelper<object>.ProcedureToList(
                    "spGetCourseExam",
                    new string[] { "@CourseID" },
                    new object[] { courseID }
                );

                var list = SQLCourseHelper<object>.GetListData(data, 0);
            ...
            try
            {
                ...
                if (examTN != null)
                {
                    var data = SQLCourseHelper<object>.ProcedureToList(
                        ...
                        new[] { "@CourseExamID", "@EmployeeID", "@OrderNumber" },
                        new object[] { examTN.ID, employeeId, 1 });
                    TracNhiem = SQLCourseHelper<object>.GetListData(data, 0);
                }
                ...
                if (examTH != null)
                {
                    var data = SQLCourseHelper<object>.ProcedureToList(
                        ...
                        new[] { "@CourseExamID" },
                        new object[] { examTH.ID });
                    ThucHanh = SQLCourseHelper<object>.GetListData(data, 0);
                }
                ...
                if (examBT != null)
                {
                    var data = SQLCourseHelper<object>.ProcedureToList(
                        ...
                        new[] { "@CourseExamID" },
                        new object[] { examBT.ID });
                    BaiTap = SQLCourseHelper<object>.GetListData(data, 0);
                }
        ...
        public async Task<IActionResult> SaveCourseExamPractice([FromBody] SaveCourseExamResultWebParam paramData)
        {
            try
            {
                if (paramData == null)
        ...
        public IActionResult GetExamResultDetail(int? courseID, int? courseResultID, int? employeeID, int? courseExamID)
        {
            try
            {
                ...
                var data = SQLCourseHelper<object>.ProcedureToList("spGetCourseExamResultDetail",
        ...
        public IActionResult GetPracticeResultHistory(int? employeeId, int? courseExamId)
        {
            try
            {
                ...
                var data = SQLCourseHelper<object>.ProcedureToList("spGetResultHistoryPractice",
        ...
        public IActionResult GetPracticeEvaluationDetails(int? courseExamId, int? employeeId, int? courseResultId)
        {
            try
            {
                ...
                var data = SQLCourseHelper<object>.ProcedureToList("spGetResultHistoryByPractice",
        ...
        public async Task<IActionResult> SavePracticeEvaluation([FromBody] SavePracticeEvaluationWebParam paramData)
        {
            try
            {
